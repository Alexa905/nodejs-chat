module.exports = function (socket) {
    ...
    return {
        ...
        botMsgs: ["Добро пожаловать в наш чатик!", "А расскажи о себе!","Lol", "Помни, чай нужно пить с малиновым вареньем!", "А мы тут плюшками балуемся...", "Да ну это все...", "Не уходи, мы же тебя любим!"]
    }
};